...
const VanillaLiquidGlass = ({ isActive = false, width = 300, height = 200 }) => {
    ...
    class Shader {
      ...
      updateShader() {
        ...
        for (let i = 0; i < data.length; i += 4) {
          ...
          // Create zoom in effect - pull pixels inward toward center
          const centerX = w / 2;
          const centerY = h / 2;
          const distanceFromCenter = Math.sqrt((x - centerX) ** 2 + (y - centerY) ** 2);
          const maxDistance = Math.sqrt(centerX ** 2 + centerY ** 2);
          const zoomFactor = 1.5; // Zoom in factor (1.5 = 50% zoom in)
          
          // Calculate displacement for zoom in effect
          const normalizedDistance = distanceFromCenter / maxDistance;
          const zoomDisplacement = normalizedDistance * (zoomFactor - 1) * 30;
          
          // Combine liquid effect with zoom effect
          const dx = (pos.x * w - x) - (x - centerX) * zoomDisplacement / maxDistance;
          const dy = (pos.y * h - y) - (y - centerY) * zoomDisplacement / maxDistance;
...
export default VanillaLiquidGlass; 